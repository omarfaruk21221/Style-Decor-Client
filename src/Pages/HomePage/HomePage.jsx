            ...
            <section className="container mx-auto px-4 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="glass-effect p-8 rounded-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
                        ...
                        <h3 className="text-2xl font-bold text-center mb-4">Interior Design</h3>
                    ...
                    <div className="glass-effect p-8 rounded-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
                        ...
                        <h3 className="text-2xl font-bold text-center mb-4">Furniture Selection</h3>
                        <p className="text-base-content/70 text-center">
                    ...
                    <div className="glass-effect p-8 rounded-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
                        ...
                        <h3 className="text-2xl font-bold text-center mb-4">Lighting Design</h3>
                        <p className="text-base-content/70 text-center">

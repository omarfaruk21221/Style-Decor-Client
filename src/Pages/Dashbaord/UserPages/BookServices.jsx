    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
        ...
        <p className="text-base-content/60 mt-2">
          Manage your booked services and track their status.
        </p>
      </motion.div>
      ...
      {bookings.length === 0 ? (
        <div className="flex flex-col items-center justify-center min-h-[40vh] bg-base-100 rounded-3xl p-8 text-center border-2 border-dashed border-base-300 shadow-sm">
          ...
          <p className="text-base-content/60 mt-2 max-w-md">
            You haven't booked any services yet. Explore our services and book
            your first one!
          </p>
        </div>
      ) : (
                ...
                >
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        ...
                        <div className="text-sm opacity-60 flex items-center gap-1 mt-1">
                          ...
                          {booking.address?.substring(0, 25)}
                  ...
                  <td>
                    {booking.paymentStatus === "paid" ? (
                      <span className="px-2 text-success font-semibold">
                        Paid
                      </span>
                    ) : (
                      <button onClick={() => handlePayBooking(booking)}>
                        <span
                          className="btn  btn-sm btn-ghost text-success bg-success/10 hover:bg-success hover:text-white transition-all tooltip tooltip-left"
                          data-tip="Pay Now"
                        >
                          <FaCreditCard />
                          <span className="px-2 text-error font-semibold">
                            Pay Now
                          </span>{" "}
                        </span>
                      </button>
                  ...
                  <td className="pr-8 text-right">
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        className="btn btn-circle btn-sm btn-ghost text-info bg-info/10 hover:bg-info hover:text-white transition-all tooltip tooltip-left"
                      ...
                      <button
                        ...
                        className="btn btn-circle btn-sm btn-ghost text-error bg-error/10 hover:bg-error hover:text-white transition-all tooltip tooltip-left"
                        data-tip="Cancel"
                      >
                        <FaTrashAlt />
                      </button>
